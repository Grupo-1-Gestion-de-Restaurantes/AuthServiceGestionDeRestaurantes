...
using AuthServiceGestionDeRestaurantes.Api.Middlewares;
using AuthServiceGestionDeRestaurantes.Api.Extensions;
using AuthServiceGestionDeRestaurantes.Api.ModelBinders;
using Serilog;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Description = "Pega tu token JWT aquí (sin la palabra Bearer). Swagger lo formateará automáticamente.",
        Name = "Authorization",
