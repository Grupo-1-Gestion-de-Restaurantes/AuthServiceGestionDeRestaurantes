...
public interface IAuthService
{
    ...
    Task<RegisterResponseDto> RegisterEmployeeAsync(RegisterEmployeeDto registerDto);
    ...
    Task<UserResponseDto> UpdateProfileAsync(string userId, UpdateProfileDto updateDto);
